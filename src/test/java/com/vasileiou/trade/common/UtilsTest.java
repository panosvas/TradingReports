...
public class UtilsTest {
	...
	/**
	 * When giving Friday with a non common currency then it should not be a
	 * working day
	 */
	@Test
	...
	/**
	 * When giving Sunday with a common currency then it should not be a working
	 * day
	 */
	@Test
	...
	/**
	 * When giving Sunday with a non common currency then it should be a working
	 * day
	 */
	@Test
	...
	/**
	 * If invalid date format is given to date conversion then it should return
	 * null
	 */
	@Test
	...
	/**
	 * If valid date is given to date conversion it should convert it
	 * successfully
	 */
	@Test
	...
	/**
	 * Given a common currency when it is Sunday, the correction should return
	 * Monday
	 */
	@Test
	public void givenCommonCurrencyWhenSundayThenMonday() {
		...
		Assert.assertEquals(Utils.dateCorrection("EUR", calendar.getTime()).toString(),
				"Mon May 22 00:00:00 EEST 2017");
	}

	/**
	 * Given a non common currency when it is Sunday, then it should return
	 * Sunday
	 */
	@Test
	public void givenExceptionCurrencyWhenSundayThenSunday() {
		...
		Assert.assertEquals(Utils.dateCorrection("SAR", calendar.getTime()).toString(),
				"Sun May 21 00:00:00 EEST 2017");
	}
