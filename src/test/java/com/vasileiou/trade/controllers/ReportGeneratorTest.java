...
public class ReportGeneratorTest {
	...
	/**
	 * Given null or empty instructions when generating daily report then no
	 * instructions available constant will be displayed
	 */
	@Test
	...
	/**
	 * Given null buy or sell when generating daily report then buy or sell
	 * missing constant will be displayed
	 */
	@Test
	public void givenNullBuyOrSellWhenGeneratingDailyReportThenBuyOrSellMissing() {
		...
		Assert.assertEquals(
				reportGenerator.generateDailyReport(validatedData.getInstructionsPerDate(), null).toString(),
				Constants.BUY_OR_SELL_IS_MISSING);
	}

	/**
	 * Given valid outgoing instructions when generating daily report then
	 * proper string will be returned
	 */
	@Test
	public void givenValidOutgoingWhenGeneratingDailyReportThenShowReport() {
		...
		ValidatedData validatedData = Parser.parseInstructions(instructions);
		Assert.assertEquals(
				reportGenerator.generateDailyReport(validatedData.getInstructionsPerDate(), BuyOrSell.BUY).toString(),
				expectedOutput);

	}

	/**
	 * Given valid incoming instructions when generating daily report then
	 * proper string will be returned
	 */
	@Test
	public void givenValidIncomingWhenGeneratingDailyReportThenShowReport() {
		...
		ValidatedData validatedData = Parser.parseInstructions(instructions);
		Assert.assertEquals(
				reportGenerator.generateDailyReport(validatedData.getInstructionsPerDate(), BuyOrSell.SELL).toString(),
				expectedOutput);

	}

	/**
	 * Given a randomly generated large input of instructions when generating
	 * daily report for outgoing for one week then Saturday should be empty as
	 * for all currencies it is included in weekend and no settlement takes
	 * place
	 */
	@Test
	...
	/**
	 * Given a randomly generated large input of instructions when generating
	 * daily report for incoming for one week then Saturday should be empty as
	 * for all currencies it is included in weekend and no settlement takes
	 * place
	 */
	@Test
	...
	/**
	 * Given null or empty instructions when generating ranking report then no
	 * instructions available constant will be displayed
	 */
	@Test
	...
	/**
	 * Given null buy or sell when generating ranking report then buy or sell
	 * missing constant will be displayed
	 */
	@Test
	...
	/**
	 * Given valid outgoing instructions when generating ranking report then
	 * proper string will be returned
	 */
	@Test
	public void givenValidOutgoingWhenGeneratingRankingReportThenShowReport() {
		...
		Assert.assertEquals(
				reportGenerator.generateRanking(validatedData.getOutgoingEntitiesMax(), BuyOrSell.BUY).toString(),
				expectedOutput);

	}

	/**
	 * Given valid incoming instructions when generating ranking report then
	 * proper string will be returned
	 */
	@Test
	public void givenValidIncomingWhenGeneratingRankingReportThenShowReport() {
		...
		Assert.assertEquals(
				reportGenerator.generateRanking(validatedData.getIncomingEntitiesMax(), BuyOrSell.SELL).toString(),
				expectedOutput);
